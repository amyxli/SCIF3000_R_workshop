...
# Can you also try adding your own labels to the x
# and y axes?
...
ggsave(
  here("plots", "q.pdf"), # what should the plot be saved as? (i.e., both path, and file name)
  q,                      # which plot do we want to save?
  width = 5, height = 3   # what size should the plot have?
)
