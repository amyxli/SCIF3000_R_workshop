...
beaches <- read_csv(MISSING_BIT("MISSING_BIT","MISSING_BIT"))
...
b + geom_violin(aes(MISSING_BIT = MISSING_BIT))
...
# options visualising the density of points at each
...
# (Hint: R might complain that you need to install
# and then load the package "hexbin" in order to use
# geom_hex(). Good thing you know how to do this already!)

MISSING_BIT # install hexbin
MISSING_BIT # load hexbin
